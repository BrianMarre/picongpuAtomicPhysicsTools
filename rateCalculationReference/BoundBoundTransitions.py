...
class BoundBoundTransitions:
    ...
    def collisionalBoundBoundCrossSection(excitation, energyElectron, energyDiffLowerUpper,
        ...
        if excitation:
            ...
            statisticalRatio = (
                BoundBoundTransitions._multiplicity(lowerStateLevelVector)/BoundBoundTransitions._multiplicity(upperStateLevelVector)
                # unitless
    ...
    def rateSpontaneousDeexcitation(absorptionOscillatorStrength, frequencyPhoton,
        ...
        ratio = BoundBoundTransitions._multiplicity(lowerStateLevelVector)/BoundBoundTransitions._multiplicity(upperStateLevelVector)
        # untiless
